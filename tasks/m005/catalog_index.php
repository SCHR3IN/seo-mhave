<?/*aspro_fix_start*/?><?if(file_exists($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/aspro.lite/tools/fix_mobile_composite.php")) include_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/aspro.lite/tools/fix_mobile_composite.php");?><?/*aspro_fix_end*/?>
<?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
$APPLICATION->SetPageProperty("description", "Широкий выбор косметики и космецевтики с доставкой по России. Напрямую от производителей. Закажите сейчас в интернет-магазине MHAVE.");
$APPLICATION->SetPageProperty("title", "Каталог профессиональной косметики — интернет-магазин MHAVE");
...
$APPLICATION->IncludeComponent(
	...
	[
		...
		"LANDING_IBLOCK_ID" => "21",
		"DETAIL_BLOCKS_TAB_ORDER" => "desc,reviews,char,faq,video,buy,docs,payment,delivery,application,dops",
		"DETAIL_BLOCKS_ALL_ORDER" => "complect,kit,sku,goods,desc,associated,expandables,video,char,reviews,docs,faq,big_gallery,articles,services,buy,payment,delivery,application,dops,comments,gift",
		"DELIVERY_CALC" => "Y",
		"DELIVERY_CALC_NAME" => "",
		"ASK_TAB" => "",
		"TAB_VACANCY_NAME" => "",
		...
		"SHOW_BUY" => "N",
		"T_PAYMENT" => "",
		"T_APPLICATION" => "Способ применения",
		"T_DELIVERY" => "",
		"SHOW_DOPS" => "N",
		...
		"IBLOCK_TIZERS_ID" => "6",
		"SHOW_REVIEW" => "Y",
		"USE_SMARTFILTER_ON_SEARCH_PAGE" => "Y",
		"T_DOPS" => "",
